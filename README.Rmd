...
These functions help users quickly analyze changes in terms over time using one of the seventeen dictionaries available on diversity-related topics.
...
Combine the `diverstidy` package with `tidytext` and `tidygraph` to make text networks.
